...
async def apply(data=None, test_mode=None):
    ...
    async with async_playwright() as p:
        ...
        await watcher_section.get_by_role("textbox", name="留守人姓名").fill(watcher['name'])
        await watcher_section.get_by_role("textbox", name="留守人手機").fill(watcher['mobilePhone'])
